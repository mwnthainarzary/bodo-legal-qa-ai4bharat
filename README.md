...
A transformer-based question answering system for bodo translated legal documents. Supports fine-tuning BERT, DistilBERT, and RoBERTa models.
...
|--------|------|------------|---------|
| Start Position Accuracy | 0.1392 | 0.1347 | 0.5455 |
| End Position Accuracy | 0.1465 | 0.1435 | 0.6549 |
| Exact Match | 0 | 0 | 0 |
| BLEU Score | 0.0028 | 0.0033 | 0.0041 |
| BERT Score F1 | 0.055 | 0.066 | 0.0546 |
| Cosine Similarity | 0.1567 | 0.1600 | 0.1385 |
